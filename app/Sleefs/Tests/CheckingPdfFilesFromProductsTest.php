...
class CheckingPdfFilesFromProductsTest extends TestCase {
    ...
    public function testCorrectProductNameToCreateDirectory(){
        ...
        $this->assertMatchesRegularExpression("/Gods\ Plan\ Black\ Sticker\ for\ Back\ Plate\ AND/",$normalizedName,"Error validando el texto: ".$normalizedName);
    ...
    public function testCorrectVariantTitleToCreatePdfFile()
    {
        ...
        $this->assertMatchesRegularExpression("/Battle\ Adult\ Chrome\ Back\ Bone\ \-\-\ Black/",$normalizedTitle,"Error validando el texto: ".$normalizedTitle);
    ...
    public function testIfDirectoryAlreadyExist()
    {
        ...
        $this->assertMatchesRegularExpression("/\ ya\ existe\ en\ el\ sistema\ de\ archivos/",$resp->notes);
    }
    ...
    public function testSeekForPdfTemplateFileFromVariantID(){
        ...
        foreach ($this->prd->variants as $variant){
            ...
            $this->assertMatchesRegularExpression('/blank/',$seekerResp->status);
            $this->assertMatchesRegularExpression("/\ __blank\.pdf$/",$seekerResp->notes);
            ...
            $this->assertTrue($seekerResp->value);
            $this->assertMatchesRegularExpression("/no\ blank/",$seekerResp->status);
            //print_r($seekerResp);
        }
        ...
        foreach ($this->prd2->variants as $variant){
            ...
            //$this->assertMatchesRegularExpression('',$seekerResp->status);
            //print_r($seekerResp);
        }
    }
